...
if(array_key_exists('delete_user_accouunt', $_POST))
{
    echo "hahaha";
...
<div class="container rounded mt-5 bg-white p-md-5">
    ...
    <div class="table-responsive">
        <table class="table">
            <form id="userinfo-form" action="modify_user_info.php?user_id= <?php echo $user_id; ?> &delivery_address= <?php echo $delivery_address; ?>" method="post">
                <tbody>
                    <tr class="bg-blue">
                    ...
                    <tr>
                        <td class="pt-6">
                        <input type="submit" id="update" value="更新使用者資訊">
                        <!--<a href="user_info.php"><input type="button" id="backindex" value="返回使用者資訊"></td></a>-->
                        </td>
                    </tr>
                    <tr>
                        <td class="pt-6">
