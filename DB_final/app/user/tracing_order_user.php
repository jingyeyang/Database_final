...
<body oncontextmenu='return false' class='snippet-body' onload="setTimeout('location.reload()', 3000)">
            ...
            <?php
                ...
                if ($result->num_rows > 0) {	
                    while ( $row = mysqli_fetch_array ( $result, MYSQLI_ASSOC ) ) {
                        ...
                        if($row["state"] === "delivering your food")
                        {
                            echo "
                            <tr class='bg-blue'>
                                <td class='pt-3 mt-1'>" . $row['order_id'] . "</td>
                                <td class='pt-3'>" . $row["order_time"] . "</td>
                                <td class='pt-3'>" . $row["state"] . "</td>
                                <td class='pt-3'><form action =''  method = 'post' class = 'form'><input type='submit' name = 'complete_order' value='complete_order' id = '". $row['order_id']  ."'></form></td>
                                <td class='pt-3'> <p align='center'><a href='order_infos_user.php?order_id=" . $row['order_id']. "&order_time=". $row['order_time'] . "'>訂單資訊</a><p></td>
                            </tr>
                            ...
                            if(array_key_exists('complete_order', $_POST))
                            {
